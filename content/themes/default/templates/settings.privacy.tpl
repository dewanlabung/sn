...
<form class="js_ajax-forms" data-url="users/settings.php?edit=privacy">
  <div class="card-body">
    ...
    <div class="form-table-row">
      <div class="avatar">
        {include file='__svg_icons.tpl' icon="unlist" class="main-icon" width="40px" height="40px"}
      </div>
      <div>
    ...
    {if $system['incognito_mode_enabled']}
      <div class="form-table-row">
        <div class="avatar">
        ...
        <div>
          ...
          <div class="form-text d-none d-sm-block">{__("When enabled, your profile will not appear in search results and you will be invisible to other users")}</div>
        </div>
        <div class="text-end">
          <label class="switch" for="user_incognito_enabled">
            <input type="checkbox" name="user_incognito_enabled" id="user_incognito_enabled" {if $user->_data['user_incognito_enabled']}checked{/if}>
            <span class="slider round"></span>
          </label>
        </div>
      </div>
    ...
    <div class="row">
      ...
      {if $system['friends_enabled']}
        <div class="form-group col-md-6">
          <label class="form-label">{__("Who can see your friends?")}</label>
          <div class="input-group">
