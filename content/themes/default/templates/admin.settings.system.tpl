      ...
      <div class="card-body">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            ...
            <div class="form-text">
              {__("This will be used to display prices on your website as default currency")}<br>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            <select class="form-select" name="system_country">
              {foreach $countries as $country}
                <option {if $country['default']}selected{/if} value="{$country['country_id']}">{$country['country_name']}</option>
              {/foreach}
            </select>
            <div class="form-text">
              {__("This will be used as a default country for your website")}<br>
              {__("You can add, edit or delete countries from")} <a href="{$system['system_url']}/{$control_panel['url']}/countries">{__("Countries")}</a>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-9">
            <select class="form-select" name="system_language">
              {foreach $languages as $language}
                <option {if $language['default']}selected{/if} value="{$language['language_id']}">{$language['title']}</option>
              {/foreach}
            </select>
            <div class="form-text">
              {__("This will be used as a default language for your website")}<br>
              {__("You can add, edit or delete languages from")} <a href="{$system['system_url']}/{$control_panel['url']}/languages">{__("Languages")}</a>
            </div>
          </div>
        </div>
    ...
    <form class="js_ajax-forms" data-url="admin/settings.php?edit=features">
      <div class="card-body">
        ...
        <div class="form-table-row">
          ...
          <div>
            <div class="form-label h6">{__("Incognito Mode")}</div>
            <div class="form-text d-none d-sm-block">
              {__("Incognito mode will hide any user from the searh results")}<br>
            </div>
          </div>
          <div class="text-end">
            <label class="switch" for="incognito_mode_enabled">
              <input type="checkbox" name="incognito_mode_enabled" id="incognito_mode_enabled" {if $system['incognito_mode_enabled']}checked{/if}>
              <span class="slider round"></span>
            </label>
          </div>
        </div>
        ...
        <div class="form-table-row">
          <div class="avatar">
            {include file='__svg_icons.tpl' icon="panic" class="main-icon" width="40px" height="40px"}
          </div>
          <div>
            <div class="form-label h6">{__("Panic Mode")}</div>
            <div class="form-text d-none d-sm-block">
              {__("Panic mode will hide all website content and show only the Google Search")}<br>
            </div>
          </div>
          <div class="text-end">
            <label class="switch" for="panic_mode_enabled">
              <input type="checkbox" name="panic_mode_enabled" id="panic_mode_enabled" {if $system['panic_mode_enabled']}checked{/if}>
              <span class="slider round"></span>
            </label>
          </div>
        </div>
