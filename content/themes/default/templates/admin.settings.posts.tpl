  ...
  <div class="card-body">
    ...
    <div class="form-table-row">
      ...
      <div>
        ...
        <div class="form-text d-none d-sm-block">
          {__("Turn the rich text posts On and Off")}<br>
        </div>
      </div>
      <div class="text-end">
        <label class="switch" for="rich_text_posts_enabled">
          <input type="checkbox" name="rich_text_posts_enabled" id="rich_text_posts_enabled" {if $system['rich_text_posts_enabled']}checked{/if}>
          <span class="slider round"></span>
        </label>
      </div>
    </div>
    ...
    <div class="form-table-row">
      ...
      <div>
        <div class="form-label h6">{__("Video Embed Code Enabled")}</div>
        <div class="form-text d-none d-sm-block">{__("Turn the video embed code enabled On and Off")}</div>
      </div>
      <div class="text-end">
        <label class="switch" for="video_embed_code_enabled">
          <input type="checkbox" name="video_embed_code_enabled" id="video_embed_code_enabled" {if $system['video_embed_code_enabled']}checked{/if}>
          <span class="slider round"></span>
        </label>
      </div>
    </div>
