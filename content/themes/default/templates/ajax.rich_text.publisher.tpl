<div class="modal-header">
  <h6 class="modal-title">
    ...
    {__("Create Rich Text Post")}
  </h6>
  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<form class="js_ajax-forms" data-url="posts/rich_text.php?do=publish">
  <div class="modal-body">
    <!-- rich text editor -->
    <div class="form-group">
      <textarea name="text" class="form-control js_wysiwyg" id="rich-text-editor"></textarea>
    </div>
    <!-- rich text editor -->
    <!-- error -->
  ...
  <div class="modal-footer">
    <input type="hidden" name="share_to" value="{$share_to}">
    <input type="hidden" name="share_to_id" value="{$share_to_id}">
