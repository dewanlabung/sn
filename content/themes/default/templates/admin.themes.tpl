      ...
      <div class="mt-4">
        ...
        <div class="d-flex py-3 px-2 align-items-start justify-content-between flex-wrap">
          <div class="d-inline-flex align-items-start">
            <a href="https://zamblek.com/marketplace/elengine-sngine-theme" target="_blank">
              <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/elengine.png" width="64" height="64">
            </a>
            <div class="ml15">
              <h5><a href="https://zamblek.com/marketplace/elengine-sngine-theme" target="_blank">Elengine - The Ultimate Sngine Theme</a></h5>
              <ul>
          ...
          <a href="https://zamblek.com/marketplace/elengine-sngine-theme" class="btn btn-md btn-success" target="_blank">
        ...
        <div class="d-flex py-3 px-2 align-items-start justify-content-between flex-wrap">
          <div class="d-inline-flex align-items-start">
            <a href="https://zamblek.com/marketplace/xngine-sngine-theme" target="_blank">
              <img src="{$system['system_url']}/content/themes/{$system['theme']}/images/icons/xngine.png" width="64" height="64">
            </a>
            <div class="ml15">
              <h5><a href="https://zamblek.com/marketplace/xngine-sngine-theme" target="_blank">Xngine – The Ultimate Sngine Theme</a></h5>
              <ul>
                <li>{__("Elegant and Modern Design")}</li>
                <li>{__("Regular and Free Updates")}</li>
                <li>{__("Lifetime support")}</li>
          ...
          <a href="https://zamblek.com/marketplace/xngine-sngine-theme" class="btn btn-md btn-success" target="_blank">
            <i class="fa-solid fa-cart-shopping mr5"></i>{__("Buy Now")}
          </a>
        </div>
      </div>
