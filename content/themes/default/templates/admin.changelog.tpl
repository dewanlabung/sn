<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="alert alert-info">
      ...
      <div class="text pt5">
        {__("All Updates are FREE for life-time if you own valid purchase code, don't have one?")} <a href="https://zamblek.com/products/sngine" target="_blank">{__("Purchase Now")}</a>
      </div>
    </div>

    <!-- Changelog -->
    <h3>Version <span class="badge bg-warning rounded-pill">4.5</span></h3>
    <blockquote>Release Date: 31st August 2026</blockquote>
    <ul class="change-log-list mb20">
      ...
      <li>[Added] New Install Wizard</li>
      <li>[Added] New Update Wizard</li>
      <li>[Added] Chat Sockets via NodeJS</li>
      <li>[Added] Paid Media Chat Messages</li>
      <li>[Added] Rich Text Posts</li>
      <li>[Added] Accordion to Rich Text Editor</li>
      <li>[Added] Video Embed Code</li>
      <li>[Added] Incognito Mode</li>
      <li>[Added] Panic Mode</li>
      <li>[Added] Translate titles & descriptions for Pages, Groups, and Events</li>
      <li>[Added] Translate Funding, Offer, Job, and Course titles</li>
      <li>[Added] Country & Language fallbacks for Pages, Groups, and Events</li>
      <li>[Fixed] Minor Bugs</li>
    </ul>

    <h3>Version <span class="badge bg-warning rounded-pill">4.4.2</span></h3>
    <blockquote>Release Date: 18th June 2026</blockquote>
    <ul class="change-log-list mb20">
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Critical Security Bug</li>
    </ul>

    <h3>Version <span class="badge bg-warning rounded-pill">4.4.1</span></h3>
    <blockquote>Release Date: 10th June 2026</blockquote>
    <ul class="change-log-list mb20">
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Critical Security Bug</li>
    </ul>

    <h3>Version <span class="badge bg-warning rounded-pill">4.4</span></h3>
    <blockquote>Release Date: 31st May 2026</blockquote>
    <ul class="change-log-list mb20">
      <li>[Updated] Documentation</li>
      <li>[Updated] System Security</li>
      <li>[Updated] System Optimization</li>
      <li>[Updated] Sngine PHP Dependencies</li>
      <li>[Updated] Sngine JS Dependencies</li>
      <li>[Added] New Social Login [Apple]</li>
      <li>[Added] New Social Login [Discord]</li>
      <li>[Added] New Cookies Consent</li>
      <li>[Added] hCaptcha Security Check</li>
      <li>[Added] CCBill Payment Support</li>
      <li>[Added] Cashapp Payment Support</li>
      <li>[Added] Blik Payment Support</li>
      <li>[Added] EPS Payment Support</li>
      <li>[Added] iDEAL Payment Support</li>
      <li>[Added] Bancontact Payment Support</li>
      <li>[Added] Przelewy24 Payment Support</li>
      <li>[Added] OXXO Payment Support</li>
      <li>[Added] Revamped Emails Templates</li>
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Custom Fields Search</li>
      <li>[Fixed] Highcharts Loading Issue</li>
      <li>[Fixed] Compo Post Issue</li>
      <li>[Fixed] Chat Text Non-Wrapping Issue</li>
      <li>[Fixed] Schedule Post Listing Issue</li>
      <li>[Fixed] Posts Reactions Update</li>
      <li>[Fixed] Paid Movies Payment Link For Non-logged In Users</li>
      <li>[Fixed] YouTube Shorts Scraping</li>
      <li>[Fixed] RTL Publisher Issues</li>
      <li>[Fixed] Blog Blockquote</li>
    </ul>

    <h3>Version <span class="badge bg-warning rounded-pill">4.3</span></h3>
    <blockquote>Release Date: 8th April 2026</blockquote>
    <ul class="change-log-list mb20">
      <li>[Updated] Documentation</li>
      <li>[Updated] System Security</li>
      <li>[Updated] System Optimization</li>
      <li>[Updated] Sngine PHP Dependencies</li>
      <li>[Updated] Sngine JS Dependencies</li>
      <li>[Added] AI System and Integration with OpenAI and Replicate</li>
      <li>[Added] AI Posts Generator</li>
      <li>[Added] AI Blogs Generator</li>
      <li>[Added] AI Images Generator</li>
      <li>[Added] AI Credit System</li>
      <li>[Added] Publisher Rich Text Editor</li>
      <li>[Added] Publisher #Hashtags Autocomplete</li>
      <li>[Added] Monetization Discounts</li>
      <li>[Added] Monetization Coupons</li>
      <li>[Added] Collaborative Posts</li>
      <li>[Added] Revamp Watch Module</li>
      <li>[Added] Blogs References</li>
      <li>[Added] Blogs Co-Authors</li>
      <li>[Added] Blogs Section To Profiles</li>
      <li>[Added] Blogs Section To Pages</li>
      <li>[Added] Blogs Section To Groups</li>
      <li>[Added] Blogs Section To Events</li>
      <li>[Added] Smart YouTube Player For Movies</li>
      <li>[Added] Disable YouTube Player For Movies</li>
      <li>[Added] Fullscreen For Games</li>
      <li>[Added] Delete All Notifications</li>
      <li>[Fixed] Minor Bugs</li>
      <li>[Fixed] Links in Posts Open in Same Window</li>
    </ul>
