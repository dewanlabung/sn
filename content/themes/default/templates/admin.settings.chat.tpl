    ...
    <form class="js_ajax-forms" data-url="admin/settings.php?edit=chat_socket">
      <div class="card-body">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            <div>
              ...
              <!-- PHP -->
              <!-- NodeJS -->
              <input class="x-hidden input-label" type="radio" name="chat_socket_server" value="nodejs" id="socket_nodejs" {if $system['chat_socket_server'] == "nodejs"}checked{/if} />
            ...
            <div class="form-text">
              {__("Select your default Socket.io server")}
            </div>
          </div>
        </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-9">
            {if !$user->_data['user_demo']}
              <input type="text" class="form-control" name="nodejs_bin_path" value="{$system['nodejs_bin_path']}" placeholder="node">
            {else}
              <input type="password" class="form-control" value="*********">
            {/if}
            <div class="form-text">
