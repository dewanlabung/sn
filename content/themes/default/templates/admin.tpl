...
<div class="{if $system['fluid_design']}container-fluid{else}container{/if} mt20 sg-offcanvas">
  <div class="row">
              ...
              <li {if $view == "settings"}class="active" {/if}>
                ...
                <div class='collapse {if $view == "settings"}show{/if}' id="settings">
                  <ul>
                    ...
                    <li {if $view == "settings" && $sub_view == "ai"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/settings/ai">
                        <i class="fa-brands fa-openai fa-lg fa-fw mr10"></i>{__("AI Settings")}
                      </a>
                    </li>
        ...
        <div class="card">
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <!-- License -->
              <li {if $view == "license"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/license">
                  <i class="fa fa-key fa-lg fa-fw mr10" style="color: #795548"></i>{__("License")}
                </a>
              </li>
              <!-- License -->
    ...
    <div class="col-md-8 col-lg-9 sg-offcanvas-mainbar">
      {if is_file("content/themes/`$system.theme`/templates/admin.`$view`.tpl")}
