      ...
      <div class="profile-header no-avatar">
        ...
        <div class="profile-name-wrapper js_translate-wrapper">
          <span class="profile-name-inner">
            <a href="{$system['system_url']}/events/{$event['event_id']}" class="event-title-text">{$event['event_title']}</a>
            ...
            {if $system['post_translation_enabled']}
              <span class="translate-icon js_translator js_translator-toggle" data-source=".event-title-text" title='{__("Translate")}' data-bs-toggle="tooltip">
      ...
      <div class="profile-tabs-wrapper d-flex justify-content-evenly">
        {if $event['event_privacy'] == "public" || $event['i_joined'] || $event['i_admin'] || $user->_is_admin || $user->_is_moderator}
          ...
          {if $system['blogs_enabled']}
            <a href="{$system['system_url']}/events/{$event['event_id']}/blogs" {if $view == "blogs"}class="active" {/if}>
                ...
                {if !is_empty($event['event_description'])}
                  <div class="about-bio js_translate-wrapper">
                    <div class="about-bio-header">
                      <div class="js_readmore overflow-hidden event-description-text">
                        {$event['event_description']|nl2br}
                      </div>
                      {if $system['post_translation_enabled']}
                        <span class="translate-icon js_translator js_translator-description" data-source=".event-description-text" data-translation=".post-text-translation" title='{__("Translate")}' data-bs-toggle="tooltip">
