...
<div class="post-header">
  ...
  <div class="post-meta">
      ...
      <div class="float-end dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end action-dropdown-menu">
          ...
          {if $_post['manage_post']}
            ...
            <!-- Pin -->
            <!-- Edit -->
            {if $_post['post_type'] == "rich_text"}
              <div class="dropdown-item pointer" data-toggle="modal" data-size="large" data-static="true" data-url="posts/rich_text.php?do=edit&post_id={$_post['post_id']}">
                <div class="action no-desc">
            ...
            <!-- Edit -->
            <!-- Monetization -->
            {if $_post['can_be_for_subscriptions'] && $_post['post_type'] != "rich_text"}
    ...
    <span class="post-title">
      ...
      {elseif $_post['post_type'] == "rich_text"}
        {__("added write-up")}
    ...
    <div class="post-time">
      ...
      {if $system['newsfeed_source'] == "default"}
        -
        {if !$_post['is_anonymous'] && !$_shared && $_post['manage_post'] && $_post['user_type'] == 'user' && !$_post['in_group'] && !$_post['in_event'] && !in_array($_post['post_type'], ['rich_text', 'article', 'product', 'funding'])}
          <!-- privacy -->
          {if $_post['privacy'] == "me"}
...
{if $_post['can_get_details'] }
  ...
  {else}
    ...
    {if $_post['post_type'] == "rich_text" && $_post['rich_text']}
      <div class="mt10 plr15">
        <div class="post-media">
          <div class="post-media-meta">
            <div class="rich-text-container">{$_post['rich_text']['parsed_text']}</div>
          </div>
        </div>
      </div>
    {/if}
          ...
          <div class="mt10 row g-1">
            ...
            {if $system['chat_enabled'] && $_post['user_type'] == 'user'}
              <div class="col-12 {if $system['market_shopping_cart_enabled']}col-md-3{/if}">
                <div class="d-grid">
                  <button type="button" class="btn btn-light js_chat-start" data-uid="{$_post['author_id']}" data-name="{$_post['post_author_name']}" data-link="{$_post['user_name']}" data-picture="{$_post['post_author_picture']}" data-product-post-id="{$_post['post_id']}">
      ...
      <div class="mt10">
        ...
        <div class="post-funding-meta">
          <div class="funding-title mb10 mt20">
            <span class="js_post_title">{$_post['funding']['title']}</span>
          </div>
    ...
    {if $_post['post_type'] == "offer" && $_post['offer']}
      <div class="mt10 plr15">
        <div class="post-media">
          ...
          <div class="post-media-meta">
            <span class="title text-active mb5 mt20 js_post_title">{$_post['offer']['meta_title']}</span>
      ...
      <div class="mt10 plr15">
        ...
        <div class="post-job-meta">
          <div class="job-title mb10 mt20">
            <a href="{$system['system_url']}/posts/{$_post['post_id']}" class="js_post_title" target="_blank">{$_post['job']['title']}</a>
          </div>
      ...
      <div class="mt10 plr15">
        ...
        <div class="post-course-meta">
          <div class="course-title mb10 mt20">
            <a href="{$system['system_url']}/posts/{$_post['post_id']}" class="js_post_title" target="_blank">{$_post['course']['title']}</a>
          </div>
          <div class="post-product-wrapper">
            <div class="post-product-details">
              <div class="title">
          ...
          <div class="mt10">
            {if $_post['needs_payment']}
              <button class="btn btn-info btn-sm {if !$user->_logged_in}js_login{/if}" {if $user->_logged_in}data-toggle="modal" data-url="#payment" data-options='{ "handle": "paid_post", "paid_post": "true", "id": {$_post['post_id']}, "price": {$_post['post_price']}, "vat": "{get_payment_vat_value($_post['post_price'])}", "fees": "{get_payment_fees_value($_post['post_price'])}", "total": "{get_payment_total_value($_post['post_price'])}", "total_printed": "{get_payment_total_value($_post['post_price'], true)}" }' {/if}>
                <i class="fa fa-money-check-alt mr5"></i>{__("PAY TO DOWNLOAD")} ({print_money($_post['post_price'])})
              </button>
            {else}
