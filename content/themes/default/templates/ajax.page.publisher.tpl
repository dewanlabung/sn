    ...
    <div class="form-group">
      ...
      <select class="form-select" name="country">
        ...
        {foreach $countries as $country}
          <option value="{$country['country_id']}" {if $country['country_id'] == $country_fallback_value}selected{/if}>{$country['country_name']}</option>
        {/foreach}
      </select>
    </div>
    <!-- country -->
    ...
    <div class="form-group">
      ...
      <select class="form-select" name="language">
        ...
        {foreach $languages as $language}
          <option value="{$language['language_id']}" {if $language['language_id'] == $language_fallback_value}selected{/if}>{$language['title']}</option>
        {/foreach}
      </select>
    </div>
    <!-- language -->
