      ...
      <div class="profile-header">
        ...
        <div class="profile-name-wrapper js_translate-wrapper">
          <span class="profile-name-inner">
            <a href="{$system['system_url']}/groups/{$group['group_name']}" class="group-title-text">{$group['group_title']}</a>
            ...
            {if $system['post_translation_enabled']}
              <span class="translate-icon js_translator js_translator-toggle" data-source=".group-title-text" title='{__("Translate")}' data-bs-toggle="tooltip">
      ...
      <div class="profile-tabs-wrapper d-flex justify-content-evenly">
        ...
        {else}
          ...
          {if $system['blogs_enabled']}
            <a href="{$system['system_url']}/groups/{$group['group_name']}/blogs" {if $view == "blogs"}class="active" {/if}>
                ...
                {if !is_empty($group['group_description'])}
                  <div class="about-bio js_translate-wrapper">
                    <div class="about-bio-header">
                      <div class="js_readmore overflow-hidden group-description-text">
                        {$group['group_description']|nl2br}
                      </div>
                      {if $system['post_translation_enabled']}
                        <span class="translate-icon js_translator js_translator-description" data-source=".group-description-text" data-translation=".post-text-translation" title='{__("Translate")}' data-bs-toggle="tooltip">
            ...
            <div class="card">
              ...
              {elseif $sub_view == "monetization"}
                <div class="card-header with-icon">
                  {if $show == "coupons"}
                    <div class="float-end">
                      <button data-toggle="modal" data-url="monetization/controller.php?do=add_coupon&node_id={$group['group_id']}&node_type=group" class="btn btn-md btn-primary">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <div class="payment-plans">
                                ...
                                {/foreach}
                                <div data-toggle="modal" data-url="monetization/controller.php?do=add_plan&node_id={$group['group_id']}&node_type=group" class="payment-plan new">{__("Add new plan")} </div>
                              </div>
                            </div>
                          </div>
                        </div>
