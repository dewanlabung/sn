...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.4',
  'unifunc' => 'content_6aad34edc2e072_49575006',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '120e749d98dbf81a3e87fb3c21029abddc5a0f43' => 
    array (
      0 => '_sign_form.tpl',
      1 => 1779964697,
      2 => 'file',
...
function content_6aad34edc2e072_49575006 (\Smarty\Template $_smarty_tpl) {
                ...
                <div class="col">
                  <div class="fr_welcome_field">
                    <select class="px-3 form-select" name="birth_day">
                      ...
                      <?php
$_smarty_tpl->assign('i', []);$_smarty_tpl->getVariable('i')->step = 1;$_smarty_tpl->getVariable('i')->total = (int) ceil(($_smarty_tpl->getVariable('i')->step > 0 ? 31+1 - (1) : 1-(31)+1)/abs($_smarty_tpl->getVariable('i')->step));
                ...
                <div class="col">
                  <div class="fr_welcome_field">
                    <select class="px-3 form-select" name="birth_year">
                      ...
                      <?php
$_smarty_tpl->assign('i', []);$_smarty_tpl->getVariable('i')->step = 1;$_smarty_tpl->getVariable('i')->total = (int) ceil(($_smarty_tpl->getVariable('i')->step > 0 ? 2023+1 - (1923) : 1923-(2023)+1)/abs($_smarty_tpl->getVariable('i')->step));
if ($_smarty_tpl->getVariable('i')->total > 0) {
for ($_smarty_tpl->getVariable('i')->value = 1923, $_smarty_tpl->getVariable('i')->iteration = 1;$_smarty_tpl->getVariable('i')->iteration <= $_smarty_tpl->getVariable('i')->total;$_smarty_tpl->getVariable('i')->value += $_smarty_tpl->getVariable('i')->step, $_smarty_tpl->getVariable('i')->iteration++) {
$_smarty_tpl->getVariable('i')->first = $_smarty_tpl->getVariable('i')->iteration === 1;$_smarty_tpl->getVariable('i')->last = $_smarty_tpl->getVariable('i')->iteration === $_smarty_tpl->getVariable('i')->total;?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
          ...
          <?php if ($_smarty_tpl->getValue('system')['captcha_enabled'] && $_smarty_tpl->getValue('system')['captcha_provider'] == "recaptcha") {?>
            <div class="form-group">
              <!-- reCAPTCHA -->
              <?php echo '<script'; ?>
...
"></div>
          ...
          <?php if ($_smarty_tpl->getValue('system')['captcha_enabled'] && $_smarty_tpl->getValue('system')['captcha_provider'] == "turnstile") {?>
            <div class="form-group">
              <!-- Turnstile -->
              <?php echo '<script'; ?>
...
" data-callback="javascriptCallback"></div>
          ...
          <?php if ($_smarty_tpl->getValue('system')['captcha_enabled'] && $_smarty_tpl->getValue('system')['captcha_provider'] == "hcaptcha") {?>
            <div class="form-group">
              <!-- hCaptcha -->
              <?php echo '<script'; ?>
 src="https://js.hcaptcha.com/1/api.js" async defer><?php echo '</script'; ?>
>
              <div class="h-captcha" data-sitekey="<?php echo $_smarty_tpl->getValue('system')['hcaptcha_site_key'];?>
"></div>
              <!-- hCaptcha -->
            </div>
          <?php }?>
...
?>
                  ...
                  <div class="col">
                    <select class="form-select" name="birth_year">
                      ...
                      <?php
$_smarty_tpl->assign('i', []);$_smarty_tpl->getVariable('i')->step = 1;$_smarty_tpl->getVariable('i')->total = (int) ceil(($_smarty_tpl->getVariable('i')->step > 0 ? 2023+1 - (1905) : 1905-(2023)+1)/abs($_smarty_tpl->getVariable('i')->step));
if ($_smarty_tpl->getVariable('i')->total > 0) {
for ($_smarty_tpl->getVariable('i')->value = 1905, $_smarty_tpl->getVariable('i')->iteration = 1;$_smarty_tpl->getVariable('i')->iteration <= $_smarty_tpl->getVariable('i')->total;$_smarty_tpl->getVariable('i')->value += $_smarty_tpl->getVariable('i')->step, $_smarty_tpl->getVariable('i')->iteration++) {
$_smarty_tpl->getVariable('i')->first = $_smarty_tpl->getVariable('i')->iteration === 1;$_smarty_tpl->getVariable('i')->last = $_smarty_tpl->getVariable('i')->iteration === $_smarty_tpl->getVariable('i')->total;?>
                        <option <?php if ($_smarty_tpl->getValue('user')->_data['user_birthdate_parsed']['year'] == $_smarty_tpl->getValue('i')) {?>selected<?php }?> value="<?php echo $_smarty_tpl->getValue('i');?>
"><?php echo $_smarty_tpl->getValue('i');?>
</option>
