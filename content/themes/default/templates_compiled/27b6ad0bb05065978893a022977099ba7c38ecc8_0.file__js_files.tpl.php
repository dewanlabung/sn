...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.4',
  'unifunc' => 'content_6aad34edd47462_05873193',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '27b6ad0bb05065978893a022977099ba7c38ecc8' => 
    array (
      0 => '_js_files.tpl',
      1 => 1788026969,
      2 => 'file',
...
function content_6aad34edd47462_05873193 (\Smarty\Template $_smarty_tpl) {
...
";var system_version = "<?php echo $_smarty_tpl->getValue('system')['system_version'];?>
...
";/* AI */<?php if ($_smarty_tpl->getValue('system')['ai_text_credit_enabled'] || $_smarty_tpl->getValue('system')['ai_image_credit_enabled']) {?>var ai_credit_cost = "<?php echo $_smarty_tpl->getValue('system')['ai_credit_cost'];?>
";<?php }
}
echo '</script'; ?>
><?php echo '<script'; ?>
>/* i18n for JS */var __ = [];__['What is on your mind?'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('What is on your mind?');?>
`;__['Write a message'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Write a message');?>
`;__['Ask something'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Ask something');?>
...
`;__['Delete All'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Delete All');?>
...
`;/* i18n for Cookies Consent */__['We use cookies'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('We use cookies');?>
`;__['We use cookies to improve your experience. You can accept, reject, or manage preferences.'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('We use cookies to improve your experience. You can accept, reject, or manage preferences.');?>
`;__['Accept all'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Accept all');?>
`;__['Reject non-essential'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Reject non-essential');?>
`;__['Manage preferences'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Manage preferences');?>
`;__['Save preferences'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Save preferences');?>
`;__['Consent Preferences Center'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Consent Preferences Center');?>
`;__['Cookie Usage'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Cookie Usage');?>
`;__['Essential cookies are always on. Choose if you want analytics cookies too.'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Essential cookies are always on. Choose if you want analytics cookies too.');?>
`;__['Strictly Necessary cookies'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Strictly Necessary cookies');?>
`;__['These cookies are essential for the proper functioning of the website and cannot be disabled.'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('These cookies are essential for the proper functioning of the website and cannot be disabled.');?>
`;__['Analytics cookies'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Analytics cookies');?>
`;__['These cookies collect information about how you use our website. All of the data is anonymized and cannot be used to identify you.'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('These cookies collect information about how you use our website. All of the data is anonymized and cannot be used to identify you.');?>
`;__['More information'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('More information');?>
`;__['For any queries in relation to my policy on cookies and your choices,'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('For any queries in relation to my policy on cookies and your choices,');?>
`;__['Contact Us'] = `<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Contact Us');?>
`;<?php echo '</script'; ?>
...
><?php echo '<script'; ?>
 src="https://cdn.plyr.io/3.8.4/plyr.js" <?php if (!$_smarty_tpl->getValue('user')->_logged_in) {?>defer<?php }?>><?php echo '</script'; ?>
><?php echo '<script'; ?>
...
echo '<script'; ?>
 src="https://maps.googleapis.com/maps/api/js?key=<?php echo $_smarty_tpl->getValue('system')['geolocation_key'];?>
&loading=async&v=beta"><?php echo '</script'; ?>
...
><?php }?><!-- Voice Notes --><!-- TinyMCE --><?php if ($_smarty_tpl->getValue('user')->_data['can_add_rich_text_posts'] || $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('page'),array("admin","blogs","forums","support"))) {
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/node_modules/tinymce/tinymce.min.js" defer><?php echo '</script'; ?>
><?php }?><!-- TinyMCE --><!-- Quill.js --><link href="https://cdn.jsdelivr.net/npm/quill@2.0.3/dist/quill.bubble.css" rel="stylesheet" /><?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/quill@2.0.3/dist/quill.js"><?php echo '</script'; ?>
><?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/quill-mention@6.1.1/dist/quill.mention.min.js"><?php echo '</script'; ?>
><link href="https://cdn.jsdelivr.net/npm/quill-mention@6.1.1/dist/quill.mention.min.css" rel="stylesheet"><!-- Quill.js --><!-- Stripe & 2Checkout & Razorpay & Shift4 & Cashfree & Epayco --><?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('page'),array("index","packages","ads","wallet","market","profile","page","group","post","directory","search","movies"))) {
if ($_smarty_tpl->getValue('system')['creditcard_enabled']) {
echo '<script'; ?>
...
echo '<script'; ?>
 src="https://sdk.twilio.com/js/video/releases/2.35.0/twilio-video.min.js" defer><?php echo '</script'; ?>
><?php }
...
echo '<script'; ?>
 src="https://download.agora.io/sdk/release/AgoraRTC_N-4.24.7.js"><?php echo '</script'; ?>
...
><?php }?><!-- Easytimer --><!-- Datatables --><?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('page'),array("admin","ads","wallet","developers","settings","page","group"))) {?><link href="https://cdn.datatables.net/v/bs5/dt-3.0.2/datatables.min.css" rel="stylesheet" integrity="sha384-WF7rwYENOlMDvld6NrDCybYx4zw25V2G1g3yQABr10/zSiPSew1KJZw0/oWSTAPC" crossorigin="anonymous" defer><?php echo '<script'; ?>
 src="https://cdn.datatables.net/v/bs5/dt-3.0.2/datatables.min.js" integrity="sha384-3OH5YkC3CJnoBt0Y3tl90xrsmjoUNknIyLLhWLZ/1/7ZgpXcbhebGu0PWn0h+df0" crossorigin="anonymous" defer><?php echo '</script'; ?>
><?php }?><!-- Datatables --><!-- Tagify --><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/node_modules/@yaireo/tagify/dist/tagify.js" defer><?php echo '</script'; ?>
><link rel="stylesheet" type='text/css' href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
//node_modules/@yaireo/tagify/dist/tagify.css" defer><!-- Tagify --><!-- HTML2PDF --><?php if ($_smarty_tpl->getValue('page') == "market") {
echo '<script'; ?>
...
"><?php echo '</script'; ?>
><?php if ($_smarty_tpl->getValue('licence_monetization') && $_smarty_tpl->getSmarty()->getModifierCallback('is_file')('includes/assets/js/core/payments.js')) {
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/includes/assets/js/core/payments.js?v=<?php echo $_smarty_tpl->getValue('system')['system_version'];?>
-<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('filemtime')('includes/assets/js/core/payments.js');?>
"><?php echo '</script'; ?>
><?php }
if ($_smarty_tpl->getValue('system')['chat_enabled']) {
...
echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/4.8.1/socket.io.min.js"><?php echo '</script'; ?>
><?php }
}
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
...
"><?php echo '</script'; ?>
><?php }
if ($_smarty_tpl->getValue('system')['live_enabled'] && $_smarty_tpl->getValue('page') == "live") {
echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
...
><!-- System [JS] --><!-- Admin Charts --><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/node_modules/highcharts/highcharts.js"><?php echo '</script'; ?>
><?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/node_modules/highcharts/modules/exporting.js"><?php echo '</script'; ?>
...
>
      ...
      <?php echo '</script'; ?>
><?php }?><!-- Admin Code Editor --><?php }?><!-- Cookies Consent --><?php if ($_smarty_tpl->getValue('system')['cookie_consent_enabled']) {
echo '<script'; ?>
 src="https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.1.0/dist/cookieconsent.umd.js" <?php if (!$_smarty_tpl->getValue('user')->_logged_in) {?>defer<?php }?>><?php echo '</script'; ?>
><link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/gh/orestbida/cookieconsent@3.1.0/dist/cookieconsent.css" /><?php echo '<script'; ?>
>
      window.addEventListener("load", function() {
        ...
        CookieConsent.run({
          ...
          language: {
            default: system_langauge_code,
            translations: {
              [system_langauge_code]: {
                consentModal: {
                  title: '🍪 ' + __['We use cookies'],
                  description: __['We use cookies to improve your experience. You can accept, reject, or manage preferences.'],
                  acceptAllBtn: __['Accept all'],
                  acceptNecessaryBtn: __['Reject non-essential'],
                  showPreferencesBtn: __['Manage preferences']
                },
                preferencesModal: {
                  title: __['Consent Preferences Center'],
                  acceptAllBtn: __['Accept all'],
                  acceptNecessaryBtn: __['Reject non-essential'],
                  savePreferencesBtn: __['Save preferences'],
                  closeIconLabel: __['Close'],
                  sections: [{
                      title: __['Cookie Usage'],
                      description: __['Essential cookies are always on. Choose if you want analytics cookies too.']
                    },
                    {
                    ...
                    },
                    {
                      ...
                      description: __['For any queries in relation to my policy on cookies and your choices,'] + ' <a href="' + site_path + '/contacts">' + __['Contact Us'] + '</a>'
                    }
                  ]
                }
              }
    ...
    <?php echo '</script'; ?>
><?php }?><!-- Cookies Consent --><!-- OneSignal Notifications --><?php if ($_smarty_tpl->getValue('user')->_logged_in && $_smarty_tpl->getValue('page') != "reels" && $_smarty_tpl->getValue('system')['onesignal_notification_enabled']) {
echo '<script'; ?>
