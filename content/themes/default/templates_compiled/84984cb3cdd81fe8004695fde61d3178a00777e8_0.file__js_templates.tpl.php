...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.4',
  'unifunc' => 'content_6aad34ede11a92_50198764',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '84984cb3cdd81fe8004695fde61d3178a00777e8' => 
    array (
      0 => '_js_templates.tpl',
      1 => 1787956214,
      2 => 'file',
  ...
  array (
    ...
    'file:_js_templates.payments.tpl' => 1,
  ),
))) {
function content_6aad34ede11a92_50198764 (\Smarty\Template $_smarty_tpl) {
...
'></textarea></div><ul class="x-form-tools clearfix">{{#conversation_id}}<?php if ($_smarty_tpl->getValue('user')->_data['can_monetize_content']) {?><li class="x-form-tools-monetize" data-toggle="modal" data-static="true" data-url="chat/publisher.php?cid={{conversation_id}}"><i class="fas fa-dollar-sign fa-lg fa-fw"></i></li><?php }?>{{/conversation_id}}<?php if ($_smarty_tpl->getValue('system')['chat_photos_enabled']) {?><li class="x-form-tools-attach"><i class="far fa-image fa-lg fa-fw js_x-uploader" data-handle="chat"></i></li><?php }
...
><?php echo '<script'; ?>
 id="chat-message" type="text/template"><li><div class="conversation clearfix right" id="{{id}}"><div class="conversation-body">{{#message}}<div class="clearfix"><span class="text js_chat-color-me" {{#color}}style="background-color: {{color}}" {{/color}}>{{{message}}}</span></div>{{/message}}{{#image}}<div class="chat-message-media {{#message}}mt5{{/message}}"><span class="text-link js_lightbox-nodata d-inline-block" data-image="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
/{{image}}"><img alt="" class="img-fluid img-wrapper" src="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
/{{image}}"></span></div>{{/image}}{{#voice_note}}<div class="chat-message-media {{#message}}mt5{{/message}}"><audio class="js_audio" id="audio-{{id}}" controls preload="auto" style="width: 100%; min-width: 120px;"><source src="<?php echo $_smarty_tpl->getValue('system')['system_uploads'];?>
...
</audio></div>{{/voice_note}}<div class="time js_moment" data-time="{{time}}">{{time}}</div></div></div></li><?php echo '</script'; ?>
><?php echo '<script'; ?>
...
><?php echo '<script'; ?>
 id="publisher-mention-item" type="text/template"><div class="publisher-mention-item"><div class="publisher-mention-item__avatar"><img class="publisher-mention-item__img" src="{{avatar}}" alt="" loading="lazy" draggable="false"></div><div class="publisher-mention-item__body"><div class="publisher-mention-item__name mention-item-label">{{value}}</div></div></div><?php echo '</script'; ?>
><?php echo '<script'; ?>
 id="publisher-hashtag-item" type="text/template"><div class="publisher-hashtag-item"><div class="publisher-hashtag-item__body"><div class="publisher-hashtag-item__name mention-item-label">#{{value}}</div></div></div><?php echo '</script'; ?>
...
><!-- Hidden (Posts|Authors) --><?php }?><!-- Posts & Comments --><!-- Wallet --><?php if ($_smarty_tpl->getValue('page') == "wallet") {
echo '<script'; ?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_affiliates"><div class="modal-body"><div class="bs-callout bs-callout-warning mt0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Affiliates Balance");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('user')->_data['user_affiliate_balance']);?>
</span></div><div class="form-group"><label class="form-label" for="amount"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Amount");?>
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_points"><div class="modal-body"><div class="bs-callout bs-callout-warning mt0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Points Balance");?>
 <span class="badge badge-lg bg-light text-primary"><?php if ($_smarty_tpl->getValue('system')['points_per_currency'] == 0) {?>0<?php } else {
...
</h6><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_market"><div class="modal-body"><div class="bs-callout bs-callout-warning mt0"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Your Marketplace Balance");?>
 <span class="badge badge-lg bg-light text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('print_money')($_smarty_tpl->getValue('user')->_data['user_market_balance']);?>
</span></div><div class="form-group"><label class="form-label" for="amount"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->getValue('system')['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->getValue('system')['system_currency_symbol'];?>
</span><input class="form-control" type="text" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="submit" class="btn btn-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Continue");?>
...
><?php }?><!-- Export CSV --><!-- Auto Connect --><?php if ($_smarty_tpl->getValue('page') == "admin" && $_smarty_tpl->getValue('view') == "tools" && $_smarty_tpl->getValue('sub_view') == "auto-connect") {
echo '<script'; ?>
...
><?php }?><!-- Auto Connect --><!-- Blog reference --><?php if ($_smarty_tpl->getValue('page') == "blogs" && $_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('view'),array('edit','new'))) {
echo '<script'; ?>
 id="blog-reference" type="text/template"><div class="auto-connect-node"><div class="row form-group"><label class="col-md-2 form-label"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("reference");?>
</label><div class="col-md-10"><input type="text" class="form-control mb10" name="references[{{index}}][title]" placeholder="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Title');?>
"><input type="text" class="form-control mb10" name="references[{{index}}][link]" placeholder="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')('Link');?>
"><div class="form-text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Add a reference title and link to cite your source");?>
</div></div></div></div><?php echo '</script'; ?>
><?php }?><!-- Blog reference --><?php if ($_smarty_tpl->getValue('licence_monetization') && $_smarty_tpl->getSmarty()->getModifierCallback('is_file')("content/themes/".((string)$_smarty_tpl->getValue('system')['theme'])."/templates/_js_templates.payments.tpl")) {
$_smarty_tpl->renderSubTemplate('file:_js_templates.payments.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), (int) 0, $_smarty_current_dir);
}
}
}
}
