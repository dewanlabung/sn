  ...
  switch ($_POST['do']) {
    case 'factory_reset':
      ...
      $tables = [
        ...
        "conversations_messages_media",
        "conversations_messages_paid",
        ...
        "posts",
        "posts_articles",
        "posts_articles_references",
        "posts_audios",
        "posts_cache",
        "posts_collaborative_users",
        "posts_comments",
      ...
      $db->query(sprintf("UPDATE users SET 
          ...
          user_monetization_enabled = '0',
          user_monetization_discount_enabled = '0',
          user_monetization_discount_percent = '0',
      ...
      update_system_options([
        ...
        'posts_schedule_enabled' => secure('1'),
        'posts_approval_enabled' => secure('0'),
        'posts_approval_limit' => secure('5'),
        ...
        'ai_mode' => secure('live'),
        'ai_posts_enabled' => secure('0'),
        'ai_posts_provider' => secure('openai'),
        'ai_blogs_enabled' => secure('0'),
        'ai_blogs_provider' => secure('openai'),
        'ai_images_enabled' => secure('0'),
        'openai_api_key' => secure(''),
        'openai_text_model' => secure(''),
        'openai_image_model' => secure(''),
        'replicate_api_token' => secure(''),
        'replicate_model' => secure(''),
        'replicate_denoising_steps' => secure('1'),
        'replicate_guidance_scale' => secure('1'),
        'replicate_seed' => secure(''),
        'ai_credit_cost' => secure('100'),
        'ai_text_credit_enabled' => secure('1'),
        'ai_generated_word_cost' => secure('10'),
        'ai_image_credit_enabled' => secure('1'),
        'ai_generated_image_cost' => secure('25'),
        ...
        'apple_login_enabled' => secure('0'),
        'apple_appid' => secure(''),
        'apple_team_id' => secure(''),
        'apple_key_id' => secure(''),
        'apple_key_content' => secure(''),
        ...
        'discord_login_enabled' => secure('0'),
        'discord_appid' => secure(''),
        'discord_secret' => secure(''),
        ...
        'cashapp_enabled' =>  secure('0'),
        'blik_enabled' =>  secure('0'),
        'eps_enabled' =>  secure('0'),
        'ideal_enabled' =>  secure('0'),
        'bancontact_enabled' =>  secure('0'),
        'przelewy24_enabled' =>  secure('0'),
        'oxxo_enabled' =>  secure('0'),
        'stripe_mode' => secure(''),
        ...
        'ccbill_enabled' => secure('0'),
        'ccbill_account_number' => secure(''),
        'ccbill_recurring_subaccount_number' => secure(''),
        'ccbill_one_time_subaccount_number' => secure(''),
        'ccbill_flexform_id' => secure(''),
        'ccbill_salt_key' => secure(''),
        'ccbill_datalink_username' => secure(''),
        'ccbill_datalink_password' => secure(''),
        ...
        'captcha_enabled' => secure('0'),
        'captcha_provider' => secure('recaptcha'),
        'reCAPTCHA_site_key' => secure(''),
        'reCAPTCHA_secret_key' => secure(''),
        'turnstile_site_key' => secure(''),
        'turnstile_secret_key' => secure(''),
        'hcaptcha_site_key' => secure(''),
        'hcaptcha_secret_key' => secure(''),
