...
admin_access('mods_users_permission');
  ...
  switch ($_REQUEST['do']) {
    ...
    case 'edit_account':
      ...
      if ($_POST['user_password'] == "") {
        ...
        $user->check_password($_POST['user_password']);
      ...
      $_POST['user_started'] = (isset($_POST['user_started'])) ? '1' : '0';
      ...
      /* update */
      $db->query(sprintf("UPDATE users SET user_verified = %s, user_banned = %s, user_banned_message = %s, user_activated = %s, user_started = %s, user_demo = %s, user_group = %s, user_group_custom = %s, user_name = %s, user_email = %s, user_email_verified = %s, user_phone = %s, user_phone_verified = %s, user_password = %s WHERE user_id = %s", secure($_POST['user_verified']), secure($_POST['user_banned']), secure($_POST['user_banned_message']), secure($_POST['user_activated']), secure($_POST['user_started']), secure($_POST['user_demo']), secure($user_group, 'int'), secure($custom_user_group, 'int'), secure($_POST['user_name']), secure($_POST['user_email']), secure($_POST['user_email_verified']), ($_POST['user_phone'] == null) ? 'null' : secure($_POST['user_phone']), secure($_POST['user_phone_verified']), secure($_POST['user_password']), secure($_GET['id'], 'int')));
      /* return */
    ...
    case 'edit_privacy':
      ...
      $_POST['user_suggestions_hidden'] = (isset($_POST['user_suggestions_hidden'])) ? '1' : '0';
      ...
      $_POST['user_privacy_collaborative'] = (isset($_POST['user_privacy_collaborative'])) ? $_POST['user_privacy_collaborative'] : 'public';
      ...
      $db->query(sprintf(
        ...
        secure($_POST['user_suggestions_hidden']),
        ...
        secure($_POST['user_privacy_collaborative']),
    ...
    case 'edit_extra':
      ...
      if ($_POST['custom_affiliates_system']) {
        if (is_empty($_POST['affiliates_per_user']) || !is_numeric($_POST['affiliates_per_user']) || $_POST['affiliates_per_user'] < 0) {
          throw new Exception(__("You must enter valid amount of money"));
        }
        if (is_empty($_POST['affiliates_per_user_2']) || !is_numeric($_POST['affiliates_per_user_2']) || $_POST['affiliates_per_user_2'] < 0) {
          throw new Exception(__("You must enter valid amount of money"));
        }
        if (is_empty($_POST['affiliates_per_user_3']) || !is_numeric($_POST['affiliates_per_user_3']) || $_POST['affiliates_per_user_3'] < 0) {
          throw new Exception(__("You must enter valid amount of money"));
        }
        if (is_empty($_POST['affiliates_per_user_4']) || !is_numeric($_POST['affiliates_per_user_4']) || $_POST['affiliates_per_user_4'] < 0) {
          throw new Exception(__("You must enter valid amount of money"));
        }
        if (is_empty($_POST['affiliates_per_user_5']) || !is_numeric($_POST['affiliates_per_user_5']) || $_POST['affiliates_per_user_5'] < 0) {
          throw new Exception(__("You must enter valid amount of money"));
        }
        if (is_empty($_POST['affiliates_percentage']) || !is_numeric($_POST['affiliates_percentage']) || $_POST['affiliates_percentage'] < 0) {
          throw new Exception(__("You must enter valid percentage"));
        }
        if (is_empty($_POST['affiliates_percentage_2']) || !is_numeric($_POST['affiliates_percentage_2']) || $_POST['affiliates_percentage_2'] < 0) {
          throw new Exception(__("You must enter valid percentage"));
        }
        if (is_empty($_POST['affiliates_percentage_3']) || !is_numeric($_POST['affiliates_percentage_3']) || $_POST['affiliates_percentage_3'] < 0) {
          throw new Exception(__("You must enter valid percentage"));
        }
        if (is_empty($_POST['affiliates_percentage_4']) || !is_numeric($_POST['affiliates_percentage_4']) || $_POST['affiliates_percentage_4'] < 0) {
          throw new Exception(__("You must enter valid percentage"));
        }
        ...
        $_POST['affiliates_per_user_2'] = $user_info['affiliates_per_user_2'];
        $_POST['affiliates_percentage_2'] = $user_info['affiliates_percentage_2'];
        $_POST['affiliates_per_user_3'] = $user_info['affiliates_per_user_3'];
        $_POST['affiliates_percentage_3'] = $user_info['affiliates_percentage_3'];
        $_POST['affiliates_per_user_4'] = $user_info['affiliates_per_user_4'];
      ...
      $db->query(sprintf(
        ...
        WHERE user_id = %s",
        secure($_POST['custom_affiliates_system']),
